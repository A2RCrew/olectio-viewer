...
const scrollController = (
  ...
  state.olectioContainerNode?.addEventListener('dragstart', avoidDrag);
  state.olectioContainerNode?.addEventListener('dragend', avoidDrag);

  state.olectioContainerNode?.addEventListener('mousedown', onDragStart);
  state.olectioContainerNode?.addEventListener('touchstart', onDragStart);
  ...
  state.olectioContainerNode?.addEventListener('wheel', onWheel);
